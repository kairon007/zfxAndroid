package com.zifei.corebeau.extra.pla;
...
import com.zifei.corebeau.extra.pla.internal.PLA_ListView;
import com.zifei.corebeau.extra.pla.internal.PLA_AbsListView.OnScrollListener;

public class PullSingleListView extends SingleColumnListView implements OnScrollListener {
	 ...
	 * @param context
	 */
	public PullSingleListView(Context context) {
		super(context);
		initWithContext(context);
	}

	public PullSingleListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initWithContext(context);
	}

	public PullSingleListView(Context context, AttributeSet attrs, int defStyle) {
